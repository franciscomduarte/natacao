...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($prova && $tempo) {
        $tempoReferencia = $indiceObj->obterTempoReferenciaFINA($prova, $sexo);
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            <span>Veja os tempos base da FINA <a href="https://resources.fina.org/fina/document/2025/01/08/baaf68c9-0118-42c3-ac3f-e11ce013fd8a/Points-Base-times-SCM-and-LCM-2025.pdf" target="_blank">aqui</a></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
