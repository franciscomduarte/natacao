                            ...
                            <tbody>
                                <?php foreach ($atletas as $a): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php $_SERVER['DOCUMENT_ROOT']?>/natacao/private/inconsistencia/form.php?id=<?= $a['id'] ?>" class="btn btn-sm btn-primary">Editar</a>
                                            <a href="<?php $_SERVER['DOCUMENT_ROOT']?>/natacao/private/inconsistencia/excluir.php?id=<?= $a['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Tem certeza?')">Excluir</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
